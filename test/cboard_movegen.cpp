...
int testPawnGen() {
  ...
  CBoard board("rnb1kb1r/1p3p1p/p3pp2/4p3/3N1P2/q1N5/P1PQ2PP/1R2KB1R", "w",
               "Kkq");
  ...
  ASSERT(!memcmp(moveList, expectedMoves, sizeof(moveList[0]) * 256),
...
int testPawnGenPromotions() {
  ...
  for (ind special = PROMOTE_KNIGHT; special <= PROMOTE_QUEEN; special++) {
    expectedMoves[special] =
        moves::make(H2, H1, PAWN, NONE, NONE, NONE, special);
    expectedMoves[100 + special] =
...
int testPawnCaps() {
  ...
  ASSERT(!memcmp(capList, expectedCaps, sizeof(capList[0]) * 256),
...
int testKnightGen() {
  ...
  CBoard board("rnb1kb1r/1p3p1p/p3pp2/4p3/3N1P2/q7/P1PQ2PP/NR2KB1R", "w",
               "Kkq");
...
int testKingMoves() {
  ...
  mv expectedMoves[256] = {0};
  expectedMoves[0] = moves::make(E1, D1, KING, NONE, NONE, NONE, KING_MOVE);
  expectedMoves[1] = moves::make(E1, D2, KING, NONE, NONE, NONE, KING_MOVE);
  expectedMoves[2] = moves::make(E1, E2, KING, NONE, NONE, NONE, KING_MOVE);
  expectedMoves[3] = moves::make(E1, F2, KING, NONE, NONE, NONE, KING_MOVE);
  expectedMoves[4] = moves::make(E1, F1, KING, NONE, NONE, NONE, KING_MOVE);
...
int testKingMovesCaps() {
  ...
  mv expectedMoves[256] = {0};
  expectedMoves[3] = moves::make(E1, F2, KING, PAWN, NONE, NONE, KING_MOVE);
  sort(begin(capList), end(capList));
  sort(begin(expectedMoves), end(expectedMoves));
  ASSERT(!memcmp(capList, expectedMoves, sizeof(capList[0]) * 256),
