...
// search is an implementation is PVS ("principle variation search") with various pruning
// heuristics:
...
// qsearch ("quiescence search") is alphabeta except that only exciting or "loud" nodes are
